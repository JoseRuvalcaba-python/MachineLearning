# -*- coding: utf-8 -*-
"""
Created on Fri Apr  3 12:31:04 2020
...
#Conv2D hacen una nueva serie de datos que tenga la suma de los datos de matrices 3x3
#Maxpooling toma los datos de mayor valor de la matriz grande en matrices 2x2
#Padding hace que el tamaño resultante sea el mismo que el de entrada
#Cada Conv2D realiza 32 imagenes de entrada y salida
...
modelo.fit(train_dataset,epochs=10, steps_per_epoch=math.ceil(num_train_examples/BATCH_SIZE))
